...
alias cl="clear"
alias wttr="curl http://wttr.in/Buenos+Aires"
# Text editor
export EDITOR=nvim
...
export FZF_DEFAULT_OPTS="--min-height 30 --preview-window down:70% --preview-window border --preview '(bat --style=numbers,changes --color=always {} || bat {} || tree -C {}) 2> /dev/null | head -200'"
